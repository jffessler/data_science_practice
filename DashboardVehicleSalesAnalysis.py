...
dropdown_options = [
    {'label': 'Yearly Statistic', 'value': 'Yearly Statistic'},
...
def update_input_container(selected_statistics):
    if selected_statistics == 'Yearly Statistic': 
        return False
    else: 
        return True
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average Vehicle Sales by Type in Recession"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            names = exp_rec.index,
            title='Total Expenditures by Vehicle Type During Recession').update_layout(showlegend=True))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp_data, x="unemployment_rate",
            y='Automobile_Sales',
            color = "Vehicle_Type",
        ...
        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'display': 'flex', 'flex-direction': 'column'}),
...
#          # Hint:Use the columns Vehicle_Type and Advertising_Expenditure
        ...
        Y_chart4 = dcc.Graph(
            ...
            names = "Vehicle_Type",
            title='Total Expenditures by Vehicle Type{}'.format(input_year)
            ))

# #TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(children=Y_chart1),html.Div(children=Y_chart2)],style={'display':'flex','flex-direction': 'column'}),
